...
const DakhilaPrint = () => {
    ...
    const fetchRoshidData = async () => {
      try {
        const response = await fetch(
          `https://ldtaxgov.xyz/api/apply/get-roshid/${id}`
        );
        if (!response.ok) {
              ...
              (land, index) =>
                index < halfLandCount && (
                  <tr>
                    ...
                    <td className="b1 input_bangla">{land.plotNo}</td>
                    <td className="b1">{land.landCategory}</td>
                    <td className="b1 input_bangla">{land.landArea}</td>
                  </tr>
                )
            )}
          </tbody>
  ...
  return (
    <div className="py-10 page-container bg-[#f4ffe6] w-screen min-h-screen ">
      <div
        style={{
          display: "flex",
        ...
        >
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <div className="row">
                <div className="col-md-12">
                  <div align="left" style={{ width: "330px", float: "left" }}>
                    <p>
                  ...
                  <div
                    align="center"
                    style={{ width: "90px", float: "left", paddingTop: "50px" }}
                  >
                    <QRCodeSVG
                      value={`https://dakhila.ldtaxgov.xyz/dakhila-print/${id}`}
                      size={75}
                    />
                  </div>
                  <div
