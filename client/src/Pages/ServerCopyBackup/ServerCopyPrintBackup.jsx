  ...
  return (
    <div>
      {loading ? (
        ...
        <div className="w-7/12 min-h-screen" id="pdf-content" style={{}} ref={componentRef}>
          <div className="flex flex-col justify-center items-center w-[800px] ">
            ...
            <div className="w-[750px]">
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th style={{ border: "1px solid #EEEEEE", padding: "5px" }}></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                  ...
                  <tr>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>পিন নম্বর</td>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>
                      {data?.data?.data?.pin}
                    </td>
                  </tr>
                  <tr>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>ভোটার নম্বর</td>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>
                      {data?.voter?.voter_no}
                    </td>
                  </tr>
              ...
              <table style={{ borderCollapse: "collapse", width: "60%", margin: "auto" }}>
                ...
                <tbody>
                  <tr>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>নাম (বাংলা)</td>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>
                      {data?.data?.data?.name}
                    </td>
                  </tr>
                  <tr>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>নাম (ইংরেজী)</td>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>
                      {data?.data?.data?.nameEn}
                    </td>
                  </tr>
                  <tr>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>জন্ম তারিখ</td>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>
                      {data?.data?.data?.dateOfBirth}
                    </td>
                  </tr>
                  <tr>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>পিতার নাম</td>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>
                      {data?.data?.data?.father}
                    </td>
                  </tr>
                  <tr>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>মাতার নাম</td>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>
              ...
              <table style={{ borderCollapse: "collapse", width: "60%", margin: "auto" }}>
                ...
                <tbody>
                  <tr>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>লিঙ্গ</td>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>
                  ...
                  {/* <tr>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>রক্তের গ্রুপ</td>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>
                      {data?.data?.data?.bloodGroup}
                    </td>
                  </tr> */}
                  <tr>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>জন্মস্থান</td>
                    <td style={{ border: "1px solid #EEEEEE", padding: "5px" }}>
              ...
              <table style={{ borderCollapse: "collapse", width: "60%", margin: "auto" }}>
                <thead>
                  <tr>
                    <th
                      className=""
                      style={{ border: "1px solid #EEEEEE", width: "33.25%", textAlign: "start" }}
                    >
                      বর্তমান ঠিকানা
                    </th>
                ...
                <tbody>
                  <tr>
                    <td
                      colSpan="2"
                      style={{ border: "1px solid #EEEEEE", padding: "5px", fontSize: "12px" }}
                    >
...
export default ServerCopyPrintBackup;
